...
* #### Download the Java version of the game 
  - macOS (aarch64, **for M1 / M2 Mac ONLY**) - [sy-remote-win_x86_64-linux_x86_64-mac_aarch64.jar](https://www.ole.bris.ac.uk/bbcswebdav/courses/COMS10017_2022_TB-2/content/oo/code/sy-remote-win_x86_64-linux_x86_64-mac_aarch64.jar)
  - Windows, Linux, macOS (x86_64, **anything that's not M1 / M2**) - [sy-remote-win_x86_64-linux_x86_64-mac_x86_64.jar](https://www.ole.bris.ac.uk/bbcswebdav/courses/COMS10017_2022_TB-2/content/oo/code/sy-remote-win_x86_64-linux_x86_64-mac_x86_64.jar)
...
For the online mode, you will need the server URL (**The default one is wrong!**), ``` ws://51.75.170.243:8089/panda2 ``` and credentials which are available [here](https://www.ole.bris.ac.uk/bbcswebdav/courses/COMS10017_2022_TB-2/content/oo/pdfs/2023_SY_credentials.pdf). Search for your UoB username in the 3rd column and then note down your personal username (integer on in 1st column) and password (alphanumeric string in 2nd column). Do **not** use personal data for your team's name when connecting to the game server: make up something fun!

* How do I know I am using an M1 or M2 (Apple Silicon) Mac?
...
* [cw-model](https://www.ole.bris.ac.uk/bbcswebdav/courses/COMS10017_2022_TB-2/content/oo/code/cw-model_2022.zip)
